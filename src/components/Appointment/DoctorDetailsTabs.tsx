...
import Overview from './DoctorTabs/Overview';
import Cases from './patientTabs/Cases'
import Patient from './DoctorTabs/Patient';
import Doctor_appointment from './DoctorTabs/DoctorAppointment';
import Schudules from './DoctorTabs/Schudules';
import Payrolls from './DoctorTabs/Payrolls';
