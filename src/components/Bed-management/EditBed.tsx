...
const EditBed = () => {
  ...
  const [bedType, setBedType] = useState(item.bedType._id);
  const [charge, setCharge] = useState(item.charge);
  ...
  const EditBed = async () => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      let response: any = await postApi("hospital/bed/update", submitData);
      ...
      <div className="content d-flex flex-column flex-column-fluid pt-7">
        <div className="container-fluid">
          <div className="d-md-flex align-items-center justify-content-between mb-5">
            <h1 className="mb-0 title_sm">Edit Bed</h1>
